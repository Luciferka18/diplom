...
if not exist "%PROJECT_ROOT%\my-app" (
  ...
  echo Распакуйте nashfit_media_seeder_stage27 в корень проекта, где лежат my-app и fitlab.
  pause
  exit /b 1
)
...
echo.
echo [OK] Media Seeder Stage27 установлен.
echo.
echo Что появилось:
echo - 28 WebP-картинок в fitlab/public/seed-images
