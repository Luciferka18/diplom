...
echo.
echo ============================================================
echo NASHFIT STAGE34 - ONE CLICK MEDIA SEED
echo ============================================================
echo.

if not exist "%PROJECT_ROOT%\my-app" (
  echo [ERROR] Folder my-app not found.
  echo Extract nashfit_stage34_fixed_ascii_cmd into project root next to my-app and fitlab.
  pause
  exit /b 1
)
