  ...
  return (
    <Card hover={false} className="p-6">
      ...
      {loading ? (
        ...
        <div className="mt-5 rounded-xl border border-[color:color-mix(in_srgb,var(--danger)_40%,var(--stroke))] bg-[color:var(--danger-soft)] p-4 text-sm text-[color:var(--danger)]">
          {error}
        </div>
      ) : items.length === 0 ? (
        <div className="mt-5 flex flex-col items-center rounded-xl border border-dashed border-[color:var(--stroke)] px-5 py-8 text-center">
          <Dumbbell className="h-9 w-9 text-[color:var(--accent)]/70" />
          ...
          <div className="mt-5 space-y-3">
            {items.slice(0, 3).map((item) => (
              <Link
                ...
                className="block rounded-xl border border-[color:var(--stroke)] p-4 transition hover:border-emerald-500/40 hover:bg-[color:var(--accent)]/5"
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="font-bold text-[color:var(--accent)]">{item.progress_percent}%</span>
                </div>
