...
export default function HomeExperience({ data = {} }) {
  ...
  return (
    <main className="min-h-screen bg-[color:var(--bg)] text-[color:var(--text)]">
      ...
      <section className="border-y border-[color:var(--stroke)] bg-[color:var(--panel)] px-4 py-10 md:px-8 md:py-12">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            {[
              ...
              <div
                key={item.title}
                className="group relative overflow-hidden rounded-[1.6rem] border border-[color:var(--stroke)] bg-[color:var(--bg)] p-5 transition hover:-translate-y-0.5 hover:border-[color:var(--accent)]/45 hover:shadow-[0_18px_50px_rgba(0,0,0,.08)]"
              >
