...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $locations = $this->safeCollection(function () {
        ...
        return response()->json([
            'gym' => [
                'name' => 'НашФит',
                'description' => $primaryLocation?->description ?: 'Фитнес-клуб и digital-платформа: бесплатные программы, экспертные статьи, офлайн-залы и тренировки с наставником.',
                'address' => $primaryLocation?->address ?: 'ул. Спортивная, 10',
                'phone' => $primaryLocation?->phone ?: '+7 (999) 000-00-00',
                'working_hours' => $primaryLocation?->working_hours ?: 'Ежедневно, 07:00–23:00',
            ],
            'locations' => $locations->map(fn (GymLocation $location) => $this->locationData($location))->values(),
            'stats' => $this->stats(),
