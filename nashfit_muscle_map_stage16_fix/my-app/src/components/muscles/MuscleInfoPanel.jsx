...
export default function MuscleInfoPanel({ muscle, loading }) {
  ...
  return (
    <aside className="rounded-[1.7rem] border border-[color:var(--stroke)] bg-[color:var(--panel)] p-4 shadow-[0_18px_60px_rgba(0,0,0,.07)] md:p-5">
      ...
      <div className="mt-6 border-t border-[color:var(--stroke)] pt-5">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h4 className="mt-1 text-xl font-black text-[color:var(--text)]">Лучшие упражнения</h4>
          </div>
