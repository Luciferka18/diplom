  ...
  return (
    <section className="px-4 py-14 md:px-8 md:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.12fr)_minmax(380px,.88fr)] xl:items-start">
          <div className="rounded-[2.2rem] border border-[color:var(--stroke)] bg-[color:var(--panel)] p-4 md:p-5">
            <MuscleMapSvg
            ...
            <div className="mt-5">
              <div className="mb-3 text-sm font-black uppercase tracking-[0.15em] text-[color:var(--muted)]">
