  ...
  return (
    <main className="pb-20">
      ...
      <Container size="narrow" className="mt-12">
        ...
        <div className="mt-8 overflow-hidden rounded-3xl border border-emerald-400/25 bg-gradient-to-br from-emerald-500/20 to-cyan-500/10 p-7 sm:flex sm:items-center sm:justify-between sm:gap-8">
          <div>
            <Dumbbell className="h-8 w-8 text-emerald-400" />
            <h2 className="mt-4 text-2xl font-black">Примените знания на практике</h2>
            <p className="mt-2 text-[color:var(--muted)]">Выберите бесплатную программу и отслеживайте прогресс в профиле.</p>
          </div>
          <Button as={Link} href="/programs" className="mt-5 shrink-0 sm:mt-0">Смотреть программы</Button>
        </div>

        <RecommendationHub contextType="article" contextId={article.id} className="mt-8" />
      </Container>
