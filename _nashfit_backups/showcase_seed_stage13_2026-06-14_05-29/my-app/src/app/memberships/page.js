        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-[color:var(--stroke)] bg-[color:var(--panel)] px-6 py-12 md:px-12 md:py-16 dark:border-emerald-400/20 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-emerald-950/60">
          ...
          <div className="relative max-w-3xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3 text-sm text-[color:var(--muted)] dark:text-white/70">
              <span className="rounded-xl border border-[color:var(--stroke)] bg-[color:var(--bg)] px-4 py-2 dark:border-white/10 dark:bg-white/5">Без списания посещений</span>
              <span className="rounded-xl border border-[color:var(--stroke)] bg-[color:var(--bg)] px-4 py-2 dark:border-white/10 dark:bg-white/5">Демо-оплата</span>
              <span className="rounded-xl border border-[color:var(--stroke)] bg-[color:var(--bg)] px-4 py-2 dark:border-white/10 dark:bg-white/5">Промокоды и акции</span>
            </div>
          </div>
        </section>
