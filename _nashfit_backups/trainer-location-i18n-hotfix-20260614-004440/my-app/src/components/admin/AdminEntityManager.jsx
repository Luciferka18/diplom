                  ...
                  <tr key={item.id} className="text-[color:var(--text)] hover:bg-[color:var(--bg)]/70">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex justify-end gap-2">
                        ...
                        <Button variant="outline" size="sm" onClick={() => remove(item)} disabled={busy} className="border-[color:color-mix(in_srgb,var(--danger)_40%,var(--stroke))] text-[color:var(--danger)] hover:bg-[color:var(--danger-soft)]" aria-label="Удалить">
...
function StatusBadge({ value, status: rawStatus }) {
  ...
  const className = ["paid", "published", "completed", "booked"].includes(status)
    ? "border-[color:var(--accent-border)] bg-[color:var(--accent-soft)] text-[color:var(--accent)]0"
    : ["cancelled", "refunded", "rejected"].includes(status)
      ? "border-[color:color-mix(in_srgb,var(--danger)_40%,var(--stroke))] bg-[color:var(--danger-soft)] text-[color:var(--danger)]"
      : status === "shipped"
        ? "border-cyan-500/30 bg-[color:var(--secondary-soft)] text-[color:var(--secondary)]"
        : status === "processing"
          ? "border-violet-500/30 bg-violet-500/10 text-[color:var(--warm)]"
          : "border-[color:color-mix(in_srgb,var(--warning)_40%,var(--stroke))] bg-[color:var(--warning-soft)] text-amber-500";
...
function Notice({ type, text }) {
  ...
  return (
    <Card hover={false} className={`p-4 ${success ? "border-[color:var(--accent-border)] bg-[color:var(--accent-soft)]" : "border-[color:color-mix(in_srgb,var(--danger)_40%,var(--stroke))] bg-[color:var(--danger-soft)]"}`}>
      <div className={`flex items-center gap-3 ${success ? "text-[color:var(--accent)]0" : "text-[color:var(--danger)]"}`}>
