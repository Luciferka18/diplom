...
export default function TrainerProfilePage() {
  ...
  return (
    <Section title="Мой профиль тренера" subtitle="Редактируйте информацию и расписание">
      {error && (
        <Card hover={false} className="mb-6 p-4 bg-[color:var(--danger-soft)] border-[color:color-mix(in_srgb,var(--danger)_40%,var(--stroke))]">
      ...
      {success && (
        <Card hover={false} className="mb-6 p-4 bg-[color:var(--accent-soft)] border-[color:var(--accent-border)]">
