...
Route::get('/trainers/{trainerId}/available-days', [TrainerScheduleController::class, 'availableDays']);

Route::get('/programs', [ProgramController::class, 'index']);
Route::get('/programs/{program}', [ProgramController::class, 'show']);

Route::get('/shop/overview', [ProductController::class, 'overview']);
...
Route::get('/recommendations/{sourceType}/{sourceId}', [ContentRecommendationController::class, 'show'])
    ->whereIn('sourceType', ['article', 'program'])
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/account/activity', [NotificationController::class, 'activity']);

    Route::get('/account/recommendations', [ContentRecommendationController::class, 'account']);
    ...
    Route::get('/account/favorite-products', [ShopAccountController::class, 'favorites']);
    Route::post('/products/{product}/favorite', [ShopAccountController::class, 'toggleFavorite']);
    Route::get('/account/recent-products', [ShopAccountController::class, 'recent']);
    ...
    Route::put('/account/addresses/{address}', [UserAddressController::class, 'update']);
    ...
    Route::middleware('role:admin')->group(function () {
        Route::get('/admin/activity', [NotificationController::class, 'adminActivity']);
        ...
        Route::get('/admin/recommendations', [ContentRecommendationController::class, 'adminIndex']);
        Route::post('/admin/recommendations', [ContentRecommendationController::class, 'store']);
        Route::put('/admin/recommendations/{recommendation}', [ContentRecommendationController::class, 'update']);
        Route::delete('/admin/recommendations/{recommendation}', [ContentRecommendationController::class, 'destroy']);
