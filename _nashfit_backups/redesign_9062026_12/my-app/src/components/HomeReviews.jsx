      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-6">
        <div>
          {reviewsLoading ? (
            ...
            <Card hover={false} className="p-6 border-red-500/30 bg-red-500/10">
              <p className="text-red-300">{reviewsError}</p>
            </Card>
          ) : reviews.length === 0 ? (
            <Card hover={false} className="p-6">
              Пока нет отзывов.
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        {review.targetLabel ? (
                          <div className="mt-1 inline-flex rounded-full border border-emerald-400/30 bg-emerald-500/10 px-2 py-0.5 text-xs font-medium text-emerald-300">
                            {review.targetLabel}
                          </div>
                        ) : null}
                      </div>
