  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="px-4 pb-8 md:px-8 md:pb-14">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-[color:var(--stroke)] bg-[#07101e] p-7 text-white md:p-10">
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-x-6 gap-y-3 text-sm text-white/70">
            ...
            <Link href="/memberships" className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-400 px-6 py-4 font-black text-[#07101e]">Получить предложение <ArrowRight size={19} /></Link>
          </div>
        </div>
      </section>
