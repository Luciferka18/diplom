            ...
            <Card hover={false}>
              ...
              {selectedSlot ? (
                <div className="mt-4 rounded-xl border border-[color:var(--accent)]/30 bg-[color:var(--accent)]/10 p-4">
                  ...
                  <button onClick={goToBooking} className="mt-3 w-full rounded-xl bg-[color:var(--accent)] px-4 py-3 font-bold text-slate-950 transition hover:opacity-90">
