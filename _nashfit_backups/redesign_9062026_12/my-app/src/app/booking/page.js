        ...
        <section className="overflow-hidden rounded-[2rem] border border-cyan-400/20 bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950/50 p-7 md:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-center">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4"><CalendarDays className="h-5 w-5 text-emerald-300" /><div className="mt-3 font-bold text-white">Свободные дни</div><div className="mt-1 text-xs text-white/50">Календарь обновляется автоматически</div></div>
            </div>
          </div>
        </section>
