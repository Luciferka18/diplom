  ...
  return (
    <main className="min-h-screen bg-[color:var(--bg)] pb-20">
      <section className="container-fitlab pt-8">
        <div className="relative overflow-hidden rounded-[2rem] border border-emerald-400/20 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950/70 px-6 py-12 md:px-12 md:py-16">
          <div className="absolute -right-16 -top-20 h-80 w-80 rounded-full bg-emerald-400/15 blur-3xl" />
          <div className="relative max-w-3xl">
            <span className="inline-flex items-center gap-2 rounded-full border border-emerald-400/25 bg-emerald-400/10 px-3 py-1 text-xs font-black uppercase tracking-wider text-emerald-300"><Sparkles className="h-4 w-4" /> Маркет НашФит</span>
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75"><BadgeCheck className="mb-2 h-5 w-5 text-cyan-300" /> Рекомендации тренеров</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75"><Truck className="mb-2 h-5 w-5 text-emerald-300" /> Доставка бесплатно от 5 000 ₽</div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75"><Store className="mb-2 h-5 w-5 text-violet-300" /> Самовывоз из клуба</div>
            </div>
          </div>
        </div>
      </section>
