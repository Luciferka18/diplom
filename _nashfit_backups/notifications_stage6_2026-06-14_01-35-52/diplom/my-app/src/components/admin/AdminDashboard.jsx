...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {error && (
        <Card hover={false} className="border-[color:color-mix(in_srgb,var(--warning)_40%,var(--stroke))] bg-[color:var(--warning-soft)] p-4 text-amber-600 dark:text-[color:var(--warning)]">
          {error}
        </Card>
      )}
